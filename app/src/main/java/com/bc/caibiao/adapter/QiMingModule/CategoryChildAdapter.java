...
public class CategoryChildAdapter extends BaseRecyclerAdapter<TaskCategory> {

    public CategoryChildAdapter(Context context, ArrayList<TaskCategory> datas) {
        super(context, datas);
    }
    ...
    protected void onBindContentViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        aItemViewHolder.mTitle.setText(mDatas.get(position).getCategory_group_number()+mDatas.get(position).getCategory_name());
