package com.bc.caibiao.widget.DatePicker;
...
public class PXFDatePickerYM {
    ...
    private TextView tv_cancle, tv_select, hour_text, minute_text,day_text,year_text,month_text;

    public PXFDatePickerYM(Context context, ResultHandler resultHandler, String startDate, String endDate) {
